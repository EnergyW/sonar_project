...
**Telegram-бот для автоматической обработки отзывов и вопросов на Ozon и Wildberries с помощью ИИ. Обратите внимание!!! Для работы с Ozon у продавца должна быть подписка Premium Plus.**
